    ...
    'taps': [
        {
            ...
            filters: [
                ...
                {title: 'Гигиенический душ', url: 'bide'},
            ],
        },
        {
            title: 'Основной материал',
    ...
    'accessories': [
        {
            ...
            filters: [
                {title: 'Все', url: 'all'},
                {title: 'Разделочные доски', url: 'accessories-boards'},
                {title: 'Корзины', url: 'accessories-baskets'},
                {title: 'Поддоны', url: 'accessories-pans'},
                {title: 'Адаптеры', url: 'accessories-adapters'},
                {title: 'Сифоны', url: 'accessories-siphons'},
            ],
        },
        {
            title: 'Основной материал',
