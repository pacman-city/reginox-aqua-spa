            ...
            <Tabs>
               ...
               <TabPanel className='article'>
                  ...
                  <ul>
                     <li>
                        Деловые линии —
                        <a href='https://www.dellin.ru' target='_blank' rel='noreferrer'>www.dellin.ru</a>
                     </li>
                     <li>
                        ПЭК —
                        <a
                           href='https://www.pecom.ru' target='_blank' rel='noreferrer'>www.pecom.ru</a>
                     </li>
                     <li>
                        Центральная транспортная служба —
                        <a href='https://www.cts-group.ru' target='_blank' rel='noreferrer'>www.cts-group.ru</a>
                     </li>
                     <li>
                        Желдорэкспедиция —
                        <a href='https://www.jde.ru' target='_blank' rel='noreferrer'>www.jde.ru</a>
                     </li>
                     <li>
