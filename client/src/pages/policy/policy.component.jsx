...
const Policy = () => {
   ...
   return (
      <div className='container policy' ref={ref}>
         <div className='breadcrumbs'>
            <Link to='/'>Главная</Link> / Политика конфиденциальности
         </div>
         <h1 className='title policy__title'>Политика конфиденциальности</h1>
         <div className='article'>
            <p>
               ...
               компании ЗАО «REGINOX», расположенный на доменном имени
               www.reginox.ru (далее Сайт), может получить о Пользователе во время
               использования Сайта. Используя Сайт, Пользователь выражает свое
               согласие с настоящей Политикой и указанными в ней условиями
               обработки его персональных данных; в случае несогласия с этими
               условиями Пользователь должен прекратить использование Сайта.
            </p>
            <h2 className='title-1 policy__sub-title'>ОПРЕДЕЛЕНИЕ ТЕРМИНОВ</h2>
            ...
            <ul>
               ...
               <li>
                  Администрация сайта – сотрудники, уполномоченные управлять
                  Сайтом, действующие от имени ЗАО «Карма Групп», которые
                  организуют и (или) осуществляют обработку персональных данных,
                  определяют цели обработки и состав персональных данных, а также
                  определяют действия, совершаемые с персональными данными.
               </li>
               <li>
                  Обработка персональных данных - любое действие или совокупность
                  действий, совершаемых с персональными данными (с использованием
                  средств автоматизации и без), в том числе сбор, запись,
               ...
               <li>
                  ...
                  соблюдения Администрацией сайта или иными лицами, получившими
               ...
               <li>
                  Cookies — данные, не содержащие конфиденциальной информации,
                  отправленные веб-сервером и хранимые на компьютере пользователя.
                  Cookies пересылаются веб-серверу автоматически браузером или
                  веб-клиентом каждый раз при попытке открыть страницу Сайта.
               </li>
               <li>
            ...
            <h2 className='title-1 policy__sub-title'>ОБЩИЕ ПОЛОЖЕНИЯ</h2>
            <p>
            ...
            <p>
               ...
               Компания «REGINOX» не контролирует и не несет ответственность за
            ...
            <h2 className='title-1 policy__sub-title'>
            ...
            <p>
               ...
               Сайте или при оформлении заказа Товара.
            </p>
            <p>
               ...
               заполнения регистрационной формы на Сайте и включают в себя
            ...
            <ul>
               ...
               <li>Создания учетной записи для оформления заказа.</li>
               <li>
            ...
            <p>
               ...
               органам государственной власти Российской Федерации только в
            ...
            <h2 className='title-1 policy__sub-title'>ОБЯЗАТЕЛЬСТВА СТОРОН</h2>
            <p>Пользователь обязуется:</p>
            <ul>
               <li>
                  Предоставить информацию о персональных данных, необходимую для
                  полноценного пользования Сайтом.
               </li>
               <li>
                  При необходимости обновить, дополнить предоставленную информацию
            ...
            <ul>
               ...
               <li>
                  ...
                  Пользователя, а также не осуществлять продажу, обмен, публикацию,
               ...
               <li>
                  ...
                  персональных данных Пользователя в порядке, обычно используемом
                  для защиты такого рода информации.
               </li>
            </ul>
            <h2 className='title-1 policy__sub-title'>
            ...
            <h2 className='title-1 policy__sub-title'>РАЗРЕШЕНИЕ СПОРОВ</h2>
            <p>
            ...
            <p>
               В случае, если соглашение не будет достигнуто, спор будет передан на
            ...
            <time dateTime='2020-06-14 12:00' className='policy__date'>
               «14» июня 2020 г.
            </time>
         </div>
      </div>
