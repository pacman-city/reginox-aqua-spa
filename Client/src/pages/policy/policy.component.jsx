...
const Policy = () => (
    <div className='container'>
        ...
        <div className="article">
            ...
            <h2 className={'title-1 ' + styles.title}>ОБЩИЕ ПОЛОЖЕНИЯ</h2>
            ...
            <h2 className={'title-1 ' + styles.title}>ПРЕДМЕТ ПОЛИТИКИ КОНФИДЕНЦИАЛЬНОСТИ</h2>
            ...
            <h2 className={'title-1 ' + styles.title}>ЦЕЛИ СБОРА ПЕРСОНАЛЬНОЙ ИНФОРМАЦИИ ПОЛЬЗОВАТЕЛЯ</h2>
            ...
            <h2 className={'title-1 ' + styles.title}>СПОСОБЫ И СРОКИ ОБРАБОТКИ ПЕРСОНАЛЬНОЙ ИНФОРМАЦИИ</h2>
            ...
            <h2 className={'title-1 ' + styles.title}>ОБЯЗАТЕЛЬСТВА СТОРОН</h2>
            ...
            <h2 className={'title-1 ' + styles.title}>ОТВЕТСТВЕННОСТЬ СТОРОН</h2>
            <p>
            ...
            <h2 className={'title-1 ' + styles.title}>РАЗРЕШЕНИЕ СПОРОВ</h2>
            ...
            <h2 className={'title-1 ' + styles.title}>ДОПОЛНИТЕЛЬНЫЕ УСЛОВИЯ</h2>
